...
class Timeline extends Base_Widget {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				'ts_join_discussion_text',
				[
					'label' => __( 'Join the discussion text', 'voxel-elementor' ),
					'type' => \Elementor\Controls_Manager::TEXT,
					'placeholder' => __( 'Type your text', 'voxel-elementor' ),
					'default' => esc_html__( 'Join the discussion', 'voxel-elementor' ),
				]
			);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Button: Post/Comment', 'voxel-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		*/
			...
			[
				...
				$this->add_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .status-text' => 'color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .status-text a' => 'color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .status-text a:hover' => 'color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_group_control(
					...
					[
						...
						'label' => __( 'Typography', 'voxel-elementor' ),
						'selector' => '{{WRAPPER}} .status-text a',
					]
				);
		...
		$this->start_controls_section(
			...
			[
				...
				$this->add_control(
					'rev_label',
					[
						'label' => __( 'Score label', 'voxel-elementor' ),
						'type' => \Elementor\Controls_Manager::HEADING,
						'separator' => 'before',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .rev-score span' => 'color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_responsive_control(
					'ts_rev_gap',
					[
						'label' => __( 'Score / Text gap', 'voxel-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px'],
						'range' => [
							'px' => [
						...
						'selectors' => [
							'{{WRAPPER}} .rev-score' => 'grid-gap: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_group_control(
					...
					[
						'name' => 'ts_rev_typo',
						'label' => __( 'Typography', 'voxel-elementor' ),
						'selector' => '{{WRAPPER}} .rev-score span',
					]
				);
				...
				$this->add_control(
					'star_score',
					[
						'label' => __( 'Stars score', 'voxel-elementor' ),
						'type' => \Elementor\Controls_Manager::HEADING,
						'separator' => 'before',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .rev-star-score i' => 'font-size: {{SIZE}}{{UNIT}};',
							'{{WRAPPER}} .rev-star-score svg' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .rev-star-score i' => 'color: {{VALUE}}',
							'{{WRAPPER}} .rev-star-score li:not(.active) svg' => 'fill: {{VALUE}}',
						],
					]
				);
				...
				$this->add_control(
					'numeric_score',
					[
						'label' => __( 'Numeric score', 'voxel-elementor' ),
						'type' => \Elementor\Controls_Manager::HEADING,
						'separator' => 'before',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'size_units' => [ 'px' ],
						'selectors' => [
							'{{WRAPPER}} .rev-num-score' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .rev-num-score' => 'border-radius: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .rev-num-score' => 'color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_group_control(
					...
					[
						'name' => 'ts_num_typo',
						'label' => __( 'Typography', 'voxel-elementor' ),
						'selector' => '{{WRAPPER}} .rev-num-score',
					]
				);
				...
				$this->add_control(
					'rev_cats',
					[
						'label' => __( 'Categories', 'voxel-elementor' ),
						'type' => \Elementor\Controls_Manager::HEADING,
						'separator' => 'before',
					]
				);
				...
				$this->add_responsive_control(
					'rs_minwidth',
					[
						'label' => __( 'Minimum width', 'voxel-elementor' ),
						'type' => \Elementor\Controls_Manager::SLIDER,
						'size_units' => [ 'px' ],
						'range' => [
							'px' => [
						...
						'selectors' => [
							'{{WRAPPER}} .rev-cats ' => '--max-r-width: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_control(
					'rev_cat_style',
					[
						'label' => __( 'Category name', 'voxel-elementor' ),
						'type' => \Elementor\Controls_Manager::HEADING,
						'separator' => 'before',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .review-cat span' => 'color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_group_control(
					...
					[
						'name' => 'revcat_typo',
						'label' => __( 'Typography', 'voxel-elementor' ),
						'selector' => '{{WRAPPER}} .review-cat span',
					]
				);
				...
				$this->add_control(
					...
					[
						...
						'type' => \Elementor\Controls_Manager::COLOR,
						'selectors' => [
							'{{WRAPPER}} .rev-chart li:not(.active)' => 'background-color: {{VALUE}}',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .rev-chart li' => 'height: {{SIZE}}{{UNIT}};',
						],
					]
				);
				...
				$this->add_responsive_control(
					...
					[
						...
						'selectors' => [
							'{{WRAPPER}} .rev-chart' => '--side-radius: {{SIZE}}{{UNIT}};',
		...
		$this->start_controls_section(
			'ts_timeline_load',
			[
				'label' => __( 'Button: Load more', 'voxel-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render( $instance = [] ) {
		...
		if ( ! empty( $_GET['status_id'] ) ) {
			if ( $status = \Voxel\Timeline\Status::get( $_GET['status_id'] ) ) {
		...
		$config = [
			...
			'postType' => ( $post && $post->post_type ) ? $post->post_type->get_key() : null,
		...
		if ( $post && $post->post_type ) {
			$config['reviews'] = [
				$post->post_type->get_key() => $post->post_type->reviews->get_timeline_config(),
			];
		} else {
			$config['reviews'] = (object) [];
		}
