	...
	protected function register_controls() {
			...
			$this->start_controls_tabs(
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						'ts_hide_filters',
						[
							'label' => __( 'Hide filters', 'voxel-elementor' ),
							'type' => \Elementor\Controls_Manager::SWITCHER,
							'return_value' => 'equal',
							'selectors' => [
								'{{WRAPPER}} .ts-order-filters' => 'display: none;',
							],
						]
					);
				...
				$this->start_controls_tab(
					...
					$this->add_responsive_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .data-con b, {{WRAPPER}} .data-con span' => 'margin-right: {{SIZE}}{{UNIT}};',
							],
						]
					);
					...
					$this->add_group_control(
						...
						[
							...
							'label' => __( 'Typography', 'voxel-elementor' ),
							'selector' => '{{WRAPPER}} .data-con span b',
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'type' => \Elementor\Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .data-con span b' => 'color: {{VALUE}}',
							],
						]
					);
			...
			[
				...
				$this->add_group_control(
					...
					[
						...
						'label' => __( 'Typography', 'voxel-elementor' ),
						'selector' => '{{WRAPPER}} .ts-order-status span',
					]
				);
		...
		*/
		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .canceled > *, {{WRAPPER}} .declined > *, {{WRAPPER}} .failed > *, {{WRAPPER}} .refunded > *, {{WRAPPER}} .sub_incomplete_expired > *, {{WRAPPER}} .sub_canceled > *' => 'color: {{VALUE}}',
						'{{WRAPPER}} .canceled > svg, {{WRAPPER}} .declined > svg, {{WRAPPER}} .failed > svg, {{WRAPPER}} .refunded > svg, {{WRAPPER}} .sub_incomplete_expired > svg, {{WRAPPER}} .sub_canceled > svg' => 'fill: {{VALUE}}',
					],
			...
			[
				...
				$this->add_group_control(
					...
					[
						'name' => 'ts_review_typo',
						'label' => __( 'Typography', 'voxel-elementor' ),
						'selector' => '{{WRAPPER}} .ts-inner-status span',
					]
				);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'label' => __( 'Typography', 'voxel-elementor' ),
					'selector' => '{{WRAPPER}} .ts-order-card ul span',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ts-order-card ul span' => 'color: {{VALUE}};',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					'name' => 'acc_head_typo',
					'label' => __( 'Typography', 'voxel-elementor' ),
					'selector' => '{{WRAPPER}} .order-info-head span',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .order-info-head span' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .order-info-container > ul > li span',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' => \Elementor\Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .order-info-container > ul > li span' => 'color: {{VALUE}}',
					],
				]
			);
		...
		$this->start_controls_section(
			'ts_repeater_btn',
			[
				'label' => __( 'Deliver files button', 'voxel-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render( $instance = [] ) {
		...
		$config = [
			...
			'l10n' => [
				...
				'attachFiles' => _x( 'Attach files', 'orders', 'voxel' ),
				'filesDelivered' => _x( 'Your file(s) have been delivered.', 'orders', 'voxel' ),
			],
		];
