...
class Assets_Controller extends Base_Controller {
	...
	protected function register_scripts() {
		...
		wp_register_script( 'mapbox-gl', 'https://api.mapbox.com/mapbox-gl-js/v2.15.0/mapbox-gl.js', ['vx:commons.js'], '2.15.0', true );
		wp_register_style( 'mapbox-gl', 'https://api.mapbox.com/mapbox-gl-js/v2.15.0/mapbox-gl.css', [], '2.15.0' );
		wp_register_script( 'jquery-ui-touch-punch', $vendor.'jquery-ui/touch-punch'.$suffix.'.js', ['jquery'], '0.2.3', true );
	}
