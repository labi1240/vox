						...
						<ul class="simplify-ul ts-term-dropdown-list min-scroll">
							<li>
								<a href="#" class="flexify" @click.prevent="setType('all')">
									...
									<span><?= _x( 'All requests', 'orders', 'voxel' ) ?></span>
								</a>
							</li>
							<li>
								<a href="#" class="flexify" @click.prevent="setType('incoming')">
									...
									<span><?= _x( 'Incoming', 'orders', 'voxel' ) ?></span>
								</a>
							</li>
							<li>
								<a href="#" class="flexify" @click.prevent="setType('outgoing')">
									...
									<span><?= _x( 'Outgoing', 'orders', 'voxel' ) ?></span>
								</a>
							</li>
						</ul>
					</div>
					...
					<div class="ts-term-dropdown ts-md-group">
						<ul class="simplify-ul ts-term-dropdown-list min-scroll">
							<template v-for="status_details, status_key in config.statuses">
								<li v-if="status_details.type === 'subheading'">
									<a href="#" class="flexify vx-noevent" @click.prevent>
										<span>{{ status_details.label }}</span>
									</a>
								</li>
								<li v-else>
