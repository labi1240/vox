...
abstract class Base_Post_Field extends \Voxel\Object_Fields\Base_Field {
	...
	/**
	 * Custom access path for dynamic tags. Useful when nesting
	 * dynamic tag groups, e.g. through the post relation field
	 *
	 * @since 1.3
	 */
	protected $custom_path_prefix;
	...
	public function get_path() {
		...
		if ( $this->custom_path_prefix !== null ) {
			$path = $this->custom_path_prefix.$path;
		}
	...
	public function set_custom_path_prefix( $prefix ): void {
		$this->custom_path_prefix = $prefix;
	}
