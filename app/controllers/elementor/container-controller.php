...
class Container_Controller extends \Voxel\Controllers\Base_Controller {
	...
	protected function register_container_settings( $container ) {
		...
		$container->start_controls_section( 'css_grid_vx', [
			'label' => __( 'Voxel grid (deprecated)', 'voxel-backend' ),
			'tab' => 'style',
		] );
			...
			$container->add_control( 'csgrid_on', [
				...
				'description' => __( 'This feature is deprecated as a similar feature is now built into elementor. Can be enabled in Elementor > Settings > Features', 'voxel-backend' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'selectors' => [
