...
<script type="text/html" id="create-post-product-field">
	<div class="ts-form-group ts-product-field form-field-grid">
		<div class="ts-form-group">
			...
			<div v-if="!field.required" class="switch-slider">
				...
				<div class="ts-form-group">
					...
					<div class="ts-double-input flexify force-equal">
						...
						>
							...
							<template #popup>
								<div class="ts-form-group uib b-bottom">
									<label>
										<?= _x( 'Create slot', 'product field', 'voxel' ) ?>
										<small><?= _x( 'Enter the start and end range', 'product field', 'voxel' ) ?></small>
									</label>
								</div>
								<div class="uib b-bottom">
									<input type="time" v-model="create.from">
								</div>
								<div class="">
									<input type="time" v-model="create.to">
								</div>
							</template>
						</form-group>
						...
						>
							...
							<template #popup>
								...
								<div class="uib b-bottom">
									<input type="time" v-model="generate.from">
								</div>
								<div class="uib b-bottom">
								...
								<div>
									<input type="number" v-model="generate.length" min="5">
								</div>
							</template>
						</form-group>
					</div>
